...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $search = validate($_POST['search']);
                    ...
                    $sqlsearch = "SELECT * FROM overall_appointments WHERE Name LIKE '%$search%' OR Date LIKE '%$search%' OR Time LIKE '%$search%' OR Office LIKE '%$search%' OR Branch LIKE '%$search%' ORDER BY ID DESC LIMIT $limit";
