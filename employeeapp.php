...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($totalresult > 0){
        ...
        $insertstud = "INSERT INTO employee_appointment( Name, Branch, Office, Employee, Contact, Email, Purpose, Date, Time ) 
        ...
        VALUES('$name', '$date','$time','$office','$branch','$email','Employee')";
